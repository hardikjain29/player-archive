...
const PlayerCard: React.FC<Props> = ({ profile: { id, profile } }: Props) => {
  return (
      <div className='result-content'>
        <div className='player-card slide-up-fade-in'>
            <div className='image'>
              <img alt='Fabio' src={profile.picture} />
            </div>
            <div className='age'>
            ...
            <div className='name'>
                ...
                <div className='verified'>
                  ...
                  <svg enable-background='new 0 0 24 24' fill='#000000' height='24px' width='24px' xmlns='http://www.w3.org/2000/svg'>
            ...
            <div className='team'>{profile.team}</div>
        </div>
    </div>
  )
}
